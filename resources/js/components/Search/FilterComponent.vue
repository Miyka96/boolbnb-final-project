<template>
  <div class="container-fluid d-flex flex-column align-items-center">
    <div class="filter_wrapper d-flex flex-column mb-4 pb-4">
      <h4 class="mb-1">Raggio di ricerca (km)</h4>
      <input class="mb-1" v-model="radius" type="number" min="1" max="100" />

      <h4 class="mb-1">Numero minimo di stanze</h4>
      <input class="mb-1" v-model="room_num" type="number" min="" max="15" />

      <h4 class="mb-1">Numero minimo di letti</h4>
      <input v-model="beds_num" type="number" max="25" class="mb-2" />

      <h4 class="mb-1">Altri servizi</h4>
      <div class="d-flex">
