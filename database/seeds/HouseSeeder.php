...
// =======
    ...
    $houseAdmin1->image = $faker->randomElement($housesImg)['show_img']['full'];
    ...
    $houseAdmin2->image = $faker->randomElement($housesImg)['show_img']['full'];
    ...
    $houseAdmin3->image = $faker->randomElement($housesImg)['show_img']['full'];
    ...
    for($i=0; $i < 100; $i++) {
      ...
      $house->cost_per_night = $faker->randomFloat(2, 10, 200);   
